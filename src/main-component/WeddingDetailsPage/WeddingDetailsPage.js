...
const WeddingDetailsPage = () => {
    return (
        <Fragment>
            ...
            <div className="toanhuyen-wedding-single-area section-padding">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-8 col-12">
                            <div className="toanhuyen-wedding-single-wrap">
                                <div className="toanhuyen-wedding-single-item">
                                    <div className="toanhuyen-wedding-single-main-img">
                                        <img src={wImg} alt=""/>
                                    </div>
                                    <div className="toanhuyen-wedding-single-title">
                                    ...
                                    <div className="row mt-4">
                                        <div className="col-md-6 col-sm-6 col-12">
                                            <div className="toanhuyen-p-details-img">
                                                <img src={wImg2} alt=""/>
                                            </div>
                                        </div>
                                        <div className="col-md-6 col-sm-6 col-12">
                                ...
                                <div className="toanhuyen-wedding-single-item list-widget">
                                    <div className="toanhuyen-wedding-single-title">
